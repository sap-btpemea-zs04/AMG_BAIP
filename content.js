      ...
      <div class="grid grid-2">
        <div>
          <div class="video-frame" data-video-id="v-ar-finance" data-modal="true">
            ...
            <button class="video-frame__play" aria-label="Play Accounts Receivable demo">
              <span class="video-frame__play-icon"><svg viewBox="0 0 24 24" fill="none"><path d="M8 5v14l11-7-11-7z" fill="currentColor"/></svg></span>
            </button>
            <span class="video-frame__label"><span class="rec-dot"></span> Accounts Receivable — S/4HANA Cloud</span>
          </div>
          <p class="video-caption">A day in the life of an Accounts Receivable team — My Home, To-Dos, and Cash Management working together in one Fiori experience.</p>
        </div>
        <div>
